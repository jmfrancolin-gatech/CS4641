...
plt.savefig('PCA of Wine Quality dataset')
plt.close()
...
plt.savefig('ICA of Wine Quality dataset')
plt.close()
...
plt.savefig('Random Projection of Wine Quality dataset')
plt.close()
...
plt.savefig('Chi square feature selection of Wine Quality dataset')
plt.close()
