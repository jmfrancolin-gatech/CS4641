...
#################################################
#Data set: Political Affiliation

data = pd.read_csv('tweets_dictionary.csv')
X = data.iloc[:,:300]
y = data.iloc[:,300]
...
for n_clusters in range_n_clusters:
    ...
    #plt.show()
    plt.savefig('KMeans with n_clusters = %d' % n_clusters)
    plt.close()
...
for n_clusters in range_n_clusters:
    ...
    #plt.show()
    plt.savefig('EM on original features with n_clusters = %d' % n_clusters)
    plt.close()

#################################################
#PCA feature transformation

pca = PCA(n_components=300, random_state=10)
...
for color, i in zip(colors, ['rep','dem']):
    plt.scatter(X_r[y == i, 0], X_r[y == i, 1], color=color, alpha=.8, lw=lw, label=i)
plt.legend(loc='best', shadow=False, scatterpoints=1)
plt.title('PCA of Political Affiliation')
plt.savefig('PCA of Political Affiliation')
plt.close()

#################################################
#ICA feature transformation

ica = FastICA(n_components=300, random_state=10)
...
for color, i in zip(colors, ['rep','dem']):
    plt.scatter(X_r[y == i, 0], X_r[y == i, 1], color=color, alpha=.8, lw=lw, label=i)
plt.legend(loc='best', shadow=False, scatterpoints=1)
plt.title('ICA of Political Affiliation')
plt.savefig('ICA of Political Affiliation')
plt.close()

#################################################
#Random Projection feature transformation

rca = GaussianRandomProjection(n_components=300, random_state=10)
...
for color, i in zip(colors, ['rep','dem']):
    plt.scatter(X_r[y == i, 0], X_r[y == i, 1], color=color, alpha=.8, lw=lw, label=i)
plt.legend(loc='best', shadow=False, scatterpoints=1)
plt.title('Random Projection of Political Affiliation')
plt.savefig('Random Projection of Political Affiliation')
plt.close()
...
plt.legend(loc='best', shadow=False, scatterpoints=1)
plt.title('Chi square feature selection of Political Affiliation')
plt.savefig('Chi square feature selection of Political Affiliation')
plt.close()
...
for n_clusters in range_n_clusters:
    ...
    #plt.show()
    plt.savefig('PCA with n_clusters = %d' % n_clusters)
    plt.close()
...
for n_clusters in range_n_clusters:
    ...
    #plt.show()
    plt.savefig('EM on transformed features with n_clusters = %d' % n_clusters)
    plt.close()
...
plot_learning_curve(clf, "MLP using PCA", X_pca, y, ylim=[0,1])
plot_learning_curve(clf, "MLP using ICA", X_ica, y, ylim=[0,1])
plot_learning_curve(clf, "MLP using RCA", X_rca, y, ylim=[0,1])
...
X_df[11] = y_kmeans
plot_learning_curve(clf, "MLP using PCA - Clusters as Classes", X_df, y, ylim=[0,1])

clusterer = KMeans(n_clusters=6, random_state=10).fit(X_ica)
y_kmeans = clusterer.labels_
X_df = pd.DataFrame(X_ica)
X_df[11] = y_kmeans
plot_learning_curve(clf, "MLP using ICA - Clusters as Classes", X_df, y, ylim=[0,1])

clusterer = KMeans(n_clusters=6, random_state=10).fit(X_rca)
y_kmeans = clusterer.labels_
X_df = pd.DataFrame(X_rca)
X_df[11] = y_kmeans
plot_learning_curve(clf, "MLP using RCA - Clusters as Classes", X_df, y, ylim=[0,1])
